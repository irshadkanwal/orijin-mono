...
>(({ className, children }, ref) => {
  ...
  const filterItems = (item: any) => {
    ...
    // Filter based on multiple properties, such as value, id, or description
    return (
      item.value.toLowerCase().includes(searchQuery) ||
      item.shortCode?.toLowerCase().includes(searchQuery)
    );
  };
  return (
    <CommandList
...
>(({ className, value, shortCode, children, ...props }, ref) => {
