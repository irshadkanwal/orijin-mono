...
const paymentTransactionWithRelations = Prisma.validator<Prisma.PaymentTransactionDefaultArgs>()({
  include:{
    farm: {
      include: {
        facility: true
...
export interface PaymentTransaction
  extends PrismaPaymentTransaction,
    Prisma.PaymentTransactionGetPayload<typeof paymentTransactionWithRelations> {}
// import {
//   BaseModel,
//   BaseSeasonalModel,
//   ID,
