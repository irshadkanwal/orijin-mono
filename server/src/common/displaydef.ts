    ...
    procurementComplete: {
      ...
      columns: [
        ...
        },
        {
          ...
          valueJsonata:
            "$round(-((processingProperties.afterWeight-processingProperties.beforeWeight)/ processingProperties.beforeWeight )*100,2)  & '%'",
        },
        {
        ...
        },
        {
          title: 'sackLoss',
          valueJsonata:
            '-(processingProperties.sackCountAfter - processingProperties.sackCountBefore)',
        },
        {
          title: 'weightBeforeFermentation',
          valueJsonata:
            '$formatWeightForUi(processingProperties.properties.weightAtReception)',
        },
        {
          ...
          rowConditionsForRoles: [
            {
              ...
              roles: ['admin', 'FinancialOfficer', 'FinancialManager'],
            },
          ],
          type: 'ProcessProdLot',
    ...
    collectionItemsReport: {
      ...
      columns: [
        ...
        },
        {
          ...
          value:
            'processingProperties.properties.pricePerWeight.perWeight.amount',
          filtering: true,
        },
        {
        ...
        },
        {
          ...
          value:
            'processingProperties.properties.quantityProcessedCurrentSeasonRaw',
        },
        {
          title: 'locationCode',
          value: 'processingProperties.properties.location.labelShort',
      ...
      entityActivities: {
        updateCollectedCacaoNonEssentials: {
          ...
          variables: [
            ...
            {
              name: 'name',
              updateOriginalValueKey:
                'processingProperties.properties.producer.label',
              type: 'displayObject',
              properties: {},
              submitReview: {},
              fieldType: {
            ...
            },
            {
              ...
              disable: true,
              updateOriginalValueKey:
                'processingProperties.properties.beforeWeight',
              widget: 'weight',
              properties: {
                unit: 'kg',
              },
            ...
            },
            {
              ...
              updateOriginalValueKey:
                'processingProperties.properties.receiptNumber',
              fieldType: {
                name: 'text',
                basetypeRaw: {
                  _deps: [],
            ...
            },
            {
              ...
              updateOriginalValueKey:
                'processingProperties.properties.collectionId',
              fieldType: {
                name: 'text',
                basetypeRaw: {
                  _deps: [],
        ...
        deleteThisHarvest: {
          rowConditionsForRoles: [
            {
              rowCondition:
                "$includes(['NotSet'], entity.purchaseStatus) and entity.systemState='Open'",
              roles: ['BuyingOfficer'],
            },
            {
              rowCondition: "entity.systemState='Open'",
          ...
          variables: [
            ...
            },
            {
              ...
              type: 'displayObject',
              defaultValue:
                '#JSONATA#entity.processingProperties.producer.label',
              validation: {
                required: false,
              },
              fieldType: {
            ...
            },
            {
              ...
              type: 'displayObject',
              defaultValue:
                '#JSONATA#$date(entity.processingProperties.activityStartDateTime)',
              fieldType: {
                name: 'displayObject',
                basetype: 'ANY',
                inputFieldType: 'displayObject',
            ...
            },
            {
              ...
              type: 'displayObject',
              defaultValue:
                "#JSONATA#$weight(entity.processingProperties.beforeWeight, 'kg', false)",
              fieldType: {
                name: 'displayObject',
                basetype: 'ANY',
                inputFieldType: 'displayObject',
        ...
        updateCollectedCacao: {
          ...
          variables: [
            ...
            },
            {
              ...
              submitReview: {
                expression:
                  "containerWeights[*].to_string(amount) | [join(' kg, ', @), ' kg'] | join('', @)",
              },
              validation: {
                yupRaw: {
                  _deps: [],
            ...
            },
            {
              ...
              onChange:
                "fn(calculatePriceForVarietyFromOriginProperties('beforeWeight', 'money'))",
              transform_post_submit: 'fn(convertWeight)',
              submitReview: {
                displayWidgetType: 'weight',
                expression:
                  "[to_string(beforeWeight.amount),to_string(beforeWeight.unit)] | join(' ', @)",
              },
            ...
            },
            {
              ...
              submitReview: {
                expression:
                  "[to_string(money.amount),to_string(money.unit)] | join(' ', @)",
                displayWidgetType: 'money',
              },
              disable: true,
              addToOriginProperties: true,
