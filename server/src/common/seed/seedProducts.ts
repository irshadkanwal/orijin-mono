import { CropVariety, PrismaClient } from '@prisma/client';
...
export const seedProducts = async (
  ...
  const cherryCoffeeInDBG = await prisma.product.create({
    data: {
      ...
      organic: true,
      productType: { connect: { id: cherryCoffee.id } },
      originVariety: { connect: { id: varieties[1].id } },
      originLocation: { connect: { id: locations[0].id } },
      singleOrigin: true,
      organisation,
    },
  });
  ...
  const freshCocoaInBDG = await prisma.product.create({
    data: {
      ...
      organic: true,
      productType: { connect: { id: freshCocoa.id } },
      originVariety: { connect: { id: varieties[0].id } },
      originLocation: { connect: { id: locations[0].id } },
      singleOrigin: true,
      organisation,
    },
  ...
  const parchmentCocoaInBDG = await prisma.product.create({
    data: {
      ...
      organic: true,
      dry: true,
      productType: { connect: { id: parchmentCoffee.id } },
      originVariety: { connect: { id: varieties[1].id } },
      originLocation: { connect: { id: locations[0].id } },
      singleOrigin: true,
      organisation,
  ...
  const dryCocoaInBDG = await prisma.product.create({
    data: {
      ...
      organic: true,
      dry: true,
      productType: { connect: { id: dryCocoa.id } },
      originVariety: { connect: { id: varieties[0].id } },
      originLocation: { connect: { id: locations[0].id } },
      singleOrigin: true,
      organisation,
