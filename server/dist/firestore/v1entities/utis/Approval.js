...
const _AbstractEntity = require("./AbstractEntity");
...
let Approval = class Approval extends _AbstractEntity.AbstractEntity {
    getCollection() {
        return _dbMappingUtils.collectionKeys.approvals;
    }
};
_ts_decorate([
