...
let Contract = class Contract extends _AbstractEntity.AbstractEntity {
    getCollection() {
...
_ts_decorate([
    (0, _classtransformer.Transform)(({ value })=>(0, _utils.formatDatesForFS)(value)),
    _ts_metadata("design:type", typeof Date === "undefined" ? Object : Date)
], Contract.prototype, "lastInspectionDate", void 0);
_ts_decorate([
    (0, _classtransformer.Transform)(({ value })=>(0, _utils.formatDatesForFS)(value)),
    _ts_metadata("design:type", typeof Date === "undefined" ? Object : Date)
], Contract.prototype, "firstVisitDate", void 0);
_ts_decorate([
...
], Contract.prototype, "entity", void 0);
