...
Object.defineProperty(exports, "ContactV1", {
    enumerable: true,
    get: function() {
        return ContactV1;
    }
...
let ContactV1 = class ContactV1 extends _AbstractEntity.AbstractEntity {
    getCollection() {
    ...
    constructor(...args){
        ...
        this.lastName = null;
        this.phone = null;
        this.registeredUnderPrincipalsName = false;
        this.registeredForMobileMoney = false;
        this.entity = null;
        this.wallet = null;
    }
};
...
], ContactV1.prototype, "entity", void 0);
_ts_decorate([
    (0, _classtransformer.Type)(()=>_ObjectId.ObjectId),
    _ts_metadata("design:type", typeof _ObjectId.ObjectId === "undefined" ? Object : _ObjectId.ObjectId)
], ContactV1.prototype, "wallet", void 0);
