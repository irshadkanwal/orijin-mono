...
Object.defineProperty(exports, "FirestoreCropsExporterService", {
    enumerable: true,
    get: function() {
        return FirestoreCropsExporterService;
    }
});
...
let FirestoreCropsExporterService = class FirestoreCropsExporterService extends _AbstractExporter.AbstractExporter {
    async transform(input, meta) {
        const res = new _CropV1.default();
    ...
    constructor(firestoreService, myService){
        ...
        this.logger = new _common.Logger(FirestoreCropsExporterService.name);
    }
};
FirestoreCropsExporterService = _ts_decorate([
