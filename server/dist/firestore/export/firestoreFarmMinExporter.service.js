...
Object.defineProperty(exports, "FirestoreFarmMinExporterService", {
    enumerable: true,
    get: function() {
        return FirestoreFarmMinExporterService;
    }
});
...
let FirestoreFarmMinExporterService = class FirestoreFarmMinExporterService extends _AbstractExporter.AbstractExporter {
    ...
    async transform(input, meta) {
        const res = new _Farm_minV1.default();
    ...
    constructor(firestoreService, myService){
        ...
        this.logger = new _common.Logger(FirestoreFarmMinExporterService.name);
    }
};
FirestoreFarmMinExporterService = _ts_decorate([
