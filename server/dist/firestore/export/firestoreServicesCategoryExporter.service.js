...
Object.defineProperty(exports, "FirestoreServicesCategoryExporterService", {
    enumerable: true,
    get: function() {
        return FirestoreServicesCategoryExporterService;
    }
});
...
let FirestoreServicesCategoryExporterService = class FirestoreServicesCategoryExporterService extends _AbstractExporter.AbstractExporter {
    ...
    constructor(firestoreService, myService){
        ...
        this.logger = new _common.Logger(FirestoreServicesCategoryExporterService.name);
    }
};
FirestoreServicesCategoryExporterService = _ts_decorate([
