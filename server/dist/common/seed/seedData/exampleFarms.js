...
_export(exports, {
    examplePersons: function() {
        return examplePersons;
    },
    generateOverlappingFarm: function() {
        return generateOverlappingFarm;
    },
    getExampleFarmInputs: function() {
        return getExampleFarmInputs;
    }
});
...
const examplePersons = (organisation)=>[
        {
            shortCode: 'FARM-1',
            organisation,
...
const getExampleFarmInputs = (organisation, locations, customLocations, seasonCode)=>[
        // 1st
        {
            organisation,
            facilityValues: {
                ...
                customLocation: customLocations ? customLocations.filter((loc)=>loc.type === _locationsmodel.MhCustomLocationLevels.FARMER_GROUP)[0] : null,
...
const generateOverlappingPlots = (count, chance, shortCode)=>{
    const plots = [];
    for(let i = 0; i < 1; i++){
        plots.push({
...
const generateOverlappingFarm = (index, organisation, chance, seasonCode)=>{
