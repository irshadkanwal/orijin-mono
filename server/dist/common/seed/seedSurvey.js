...
Object.defineProperty(exports, "seedSurvey", {
    enumerable: true,
    get: function() {
        return seedSurvey;
    }
});
const seedSurvey = async (prisma, user2, farmService, organisation)=>{
    ...
    const farmOne = farmsWithIncludes.data.find((farm)=>farm.facility.shortCode === 'FARM-001');
