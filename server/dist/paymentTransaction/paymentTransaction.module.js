...
Object.defineProperty(exports, "PaymentTransactionsModule", {
    enumerable: true,
    get: function() {
        return PaymentTransactionsModule;
    }
});
const _common = require("@nestjs/common");
const _paymentTransactionsservice = require("./paymentTransactions.service");
const _paymentTransactionscontroller = require("./paymentTransactions.controller");
...
PaymentTransactionsModule = _ts_decorate([
    (0, _common.Module)({
        imports: [
            _changesmodule.ChangesModule
        ],
        controllers: [
            _paymentTransactionscontroller.PaymentTransactionsController
        ],
        providers: [
