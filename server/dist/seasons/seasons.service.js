...
Object.defineProperty(exports, "SeasonsService", {
    enumerable: true,
    get: function() {
...
let SeasonsService = class SeasonsService extends _AbstractService.default {
    ...
    constructor(prisma){
        super(prisma, prisma.season);
        this.prisma = prisma;
        this.logger = new _common.Logger(SeasonsService.name);
    }
};
SeasonsService = _ts_decorate([
